...
<nav id="site-navigation" class="main-navigation">
	<div class="wrapper">		
		<div class="book-tix">
			<a class="btn-default nav-header-button" target="_blank" href="<?php the_field('book_tickets_url', 5); ?>">Book Tickets</a>
		</div>
			...
			<div class="site-branding wrapper">
				...
				<div class="centre-title" id="ban_two">
					<div class="title-wrapper">
						<p class="top-line"><span><?php the_field('centre_banner_top_line',5); ?></span></p>
