...
<?php if( $post->ID == 182) { ?>
	<nav id="site-navigation" class="main-navigation main-nav-red">
<?php } else { ?>
...
<?php } ?>
	<div class="wrapper">
							...
							<svg width="35px" height="25px" viewBox="0 0 35 25" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
								...
								<g id="Menu_EYE_Close" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
									<g id="Menu_EYE">
										...
										<path d="M9,5 L25,21" id="Path-5" stroke="#EAC1A4"></path>
										<path d="M25,5 L9,21" id="Path-5" stroke="#EAC1A4"></path>
									</g>
								</g>
							</svg>
						</div>				
		...
		<div class="all-devices-menu">
			...
			<div class="book-tix">
				<a class="btn-default nav-header-button" href="<?php echo esc_url(home_url('/tour-dates')); ?>">TOUR DATES</a>
			</div>
		</div>
	</div>
</nav>
<?php if( $post->ID == 182) { ?>
	<div id="page" class="site fullpage-wrapper parallax page-red">
<?php } else { ?>
...
<?php } ?>	
	...
	<header id="masthead" class="site-header paroller_wrapper section up-scroll" data-anchor="page_1">				
    	<div class="content-wrapper">	
			...
			<div class="book-tix mobile">
				<a class="btn-default nav-header-button" href="<?php echo esc_url(home_url('/tour-dates')); ?>">TOUR DATES</a>
			</div>	
			<div class="site-branding wrapper">
				<div class="left-title" id="ban_one"><span></span></div>
				<div class="centre-title" id="ban_two">
					<h3><?php the_field('top_quote', 5); ?></h3>
					<span><?php the_field('top_quote_name', 5); ?></span>	
					<a class="btn-default nav-header-button" href="<?php echo esc_url(home_url('/tour-dates')); ?>">TOUR DATES</a>
				</div>
				<div class="right-title" id="ban_three"><span></span></div>
			</div>		
			<div id="header_line">
			</div>
		</div>
