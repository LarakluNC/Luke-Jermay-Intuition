...
get_header();
?>
<div class=tour-dates-intu-bg">
	<div class="title-wrapper title-tour-intu">
	...
	<table>
		...
		if( have_rows('tour_dates') ):
			...
			$i++;			
		?>
		<tr class="tour_info_<?php echo $i; ?> tour-info-intu">		
			<td class="date"><?php the_sub_field('date'); ?></td>
			<td class="location"><?php the_sub_field('location'); ?></td>
			<td class="city"><?php the_sub_field('city'); ?></td>
			<td><a href="<?php the_sub_field('link'); ?>" class="book-button">BOOK TICKETS</a></td>
		</tr>
		<?php endwhile; endif; ?>
	</table>
</div>
