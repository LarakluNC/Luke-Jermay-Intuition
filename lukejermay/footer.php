...
?>
	...
	<?php if( $post->ID == 182) { ?>
		<footer id="colophon" class="site-footer section  parallax__layer parallax__layer--base footer-red">
	<?php } else { ?>
	<footer id="colophon" class="site-footer section  parallax__layer parallax__layer--base">
	<?php } ?>
		<div class="content-wrapper">			
			<div class="site-info">
				<div class="social">
					<p>
						<a href="https://www.facebook.com/jermay/" target="_blank">
						...
						<a href="https://www.instagram.com/lukejermay/" target="_blank">
						...
						<a href="https://twitter.com/LukeJermay/" target="_blank">
				...
				<p>Design &amp; build by <a class="northern-comfort" target="_blank" href="http://northerncomfort.co.uk/">Northern Comfort</a></p>			
			</div>
		</div>
		<div class="background-image-layer footer_bg" id="footer_bg"></div>
	</footer>
	<div id="video" class="lightbox" onclick="hideVideo('video','vimeo')">
		<div class="lightbox-container">
			<div class="lightbox-content">

				<button onclick="hideVideo('video','vimeo_v')" class="lightbox-close">
			Close | ✕
		  </button>
				<div class="video-container">
					<iframe id="vimeo_v" width="960" height="540" src="https://player.vimeo.com/video/278660116" frameborder="0" allowfullscreen></iframe>
				</div>
